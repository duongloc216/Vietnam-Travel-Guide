...
export const leftLinks = [
  { href: '/', title: 'Home' },
  { href: '/#places', title: 'Destinations' },
  { href: '/travel-tips', title: 'Travel Tips' },
  { href: '/tips/food', title: 'Food' },
  { href: '/tips/culture', title: 'Culture' },
];
    ...
    places: [
      {
        ...
        description: [
          "The beautiful beaches of Da Nang are known for their pristine white sand and crystal clear waters. Stretching along the coast, these beaches offer perfect spots for swimming, sunbathing, and water sports.",
          "Visit early in the morning to enjoy the peaceful atmosphere and watch the sunrise. The beaches are less crowded during weekdays, making it an ideal time for relaxation.",
          "During the daytime you can enjoy various water activities or simply relax under the shade of palm trees. At night, the beaches transform into romantic spots with beautiful city lights reflecting on the water."
        ],
        images: [
          {
            id: 1,
    ...
    places: [
      {
        ...
        description: [
          "Muong Hoa Valley is a stunning landscape of terraced rice fields and ethnic minority villages. The valley stretches for about 8 kilometers and is home to several ethnic groups including Hmong, Dao, and Tay people.",
          "Visit early in the morning to see the valley covered in mist, creating a magical atmosphere. The terraced fields change colors with the seasons, from bright green in spring to golden yellow during harvest time.",
          "During the daytime you can trek through the valley, visit local villages, and learn about traditional farming methods. At sunset, the valley offers spectacular views as the last rays of sun paint the terraces in warm colors."
        ],
        images: [
          {
            id: 1,
...

      {
        ...
        name: "Bac Ha Market",
        description: [
          "Bac Ha Market is one of the most colorful and vibrant markets in northern Vietnam. Every Sunday, ethnic minority groups from surrounding villages gather here to trade goods, socialize, and celebrate their cultural heritage.",
          "The market is famous for its traditional costumes, handicrafts, and local specialties. You can find everything from hand-woven textiles to fresh produce, livestock, and traditional medicines.",
          "Visit early in the morning to experience the market at its busiest and most authentic. The colorful traditional costumes of the Flower Hmong people make this market particularly photogenic."
        ],
...
export const tips = [
  ...
  { id: 6, title: 'culture', icon: cultureIcon },
  { id: 7, title: 'food', icon: foodIcon },
  { id: 8, title: 'accommodation', icon: accommodationIcon }
];
...
export const travelTips = [
  {
    ...
    icon: "passport",
    description: "Essential information about visas and immigration requirements for Vietnam",
    tips: [
      {
        id: 1,
      ...
      },
      {
        ...
        content: [
          "E-Visa: 3 working days, $25",
          "Visa on Arrival: 2-3 working days, $25-50",
          "Embassy Visa: 5-7 working days, $25-135",
  ...
  },
  {
    ...
    name: "Health & Safety",
    icon: "health",
    description: "Important health and safety information for travelers in Vietnam",
    tips: [
      {
        id: 1,
  ...
  },
  {
    ...
    name: "Budget & Money",
    icon: "money",
    description: "Financial tips and information for traveling in Vietnam",
    tips: [
      {
        id: 1,
        ...
        content: [
          ...
          "Best exchange rates at banks and authorized exchange offices",
      ...
      },
      {
        ...
        content: [
          ...
          "Mobile payment apps (MoMo, ZaloPay)",
          "International credit cards",
          "Traveler's checks not recommended"
        ]
      }
    ]
  },
  {
    ...
    icon: "language",
    description: "Language tips and communication guide for Vietnam",
    tips: [
      {
        id: 1,
      ...
      },
      {
        ...
        content: [
          "Learn basic numbers and prices",
  ...
  },
  {
    ...
    name: "Shopping",
    icon: "shopping",
    description: "Shopping guide and tips for Vietnam",
    tips: [
      {
        id: 1,
  ...
  },
  {
    ...
    icon: "festival",
    description: "Guide to Vietnamese festivals and cultural events",
    tips: [
      {
        id: 1,
  ...
  },
  {
    ...
    name: "Photography",
    icon: "camera",
    description: "Photography tips and best spots in Vietnam",
    tips: [
      {
        id: 1,
  ...
  },
  {
    ...
    name: "Solo Travel",
    icon: "solo",
    description: "Tips and advice for solo travelers in Vietnam",
    tips: [
      {
        id: 1,
        title: "Safety Tips",
